      ...
      <div class="row"> 
        ...
        <div class="col-md-4 col-sm-4 widget footer-widget">
          ...
          <ul>
            ...
            <li><a href="news-updates.php">Blogs</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="copyrights-col-left col-md-6 col-sm-6">
          <p>&copy; 2022 TushtinBlogs</p>
        </div>
        <div class="copyrights-col-right col-md-6 col-sm-6">
          <div class="social-icons"> <a href="https://www.facebook.com/<?php echo $row['facebook']; ?>" target="_blank"><i class="fa fa-facebook"></i></a> <a href="https://linkedin.com/<?php echo $row['linkedin']; ?>" target="_blank"><i class="fa fa-linkedin"></i></a> <a href="https://instagram.com/<?php echo $row['status']; ?>" target="_blank"><i class="fa fa-instagram"></i></a></div>
        </div>
      </div>
    </div>
	<?php } ?>
