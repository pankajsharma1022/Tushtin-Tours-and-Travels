...
<link href="css/mainpagecss.css" rel="stylesheet" type="text/css">
...
<header1>
        ...
        <div class="name">
            <h1>
                <a href="http://localhost/tushtinphp/form.php"><b> @Tushtin </b></a>
            </h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-8">
            <h1 class="logo"> <a href="tushtin blogs.php"><img src="images/logo.png" alt="Logo"></a> </h1>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
                <li><a href="tushtin blogs.php">Home</a>
                 </li>
                <li><a>About Us</a>
				<ul class="dropdown">
                  ...
                  <li><a href="news-updates.php">Blogs</a>
                </li>                  
                </li>
