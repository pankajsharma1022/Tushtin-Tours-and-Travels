          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome to Tushtin Blogs</h3>
              </header>
			  <?php
...
<?php echo $row['body']; ?>             
            ...
            <div class="listing post-listing">
              <header class="listing-header">
                <h3 class="titles">Latest Blogs</h3></header>
              <section class="listing-cont">
               ...
               ?> 
					 ...
					 <center> -- <a href="news-updates.php">All Blogs</a> --</center>
                  </li>
                </ul>
              </section>
			 </div>
              ...
              <section class="listing-cont">
                <ul>
                  <li class="item sermon featured-sermon"> <span class="date"></span>
                    <h4><a href="https://www.facebook.com/tushtin8890">Like Us on Facebook</a></h4>
					<?php
                            //include('../connect.php');
