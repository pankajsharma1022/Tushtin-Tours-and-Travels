...
<div class="page-header">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-2 col-sm-2 col-xs-4"> <a href="donate.php" class="pull-right btn btn-primary">All causes</a> </div>
    </div>
  </div>
</div>
<!-- End Page Header -->
      ...
      <div class="row">
        <div class="col-md-9">
          <header class="single-post-header clearfix">
            <h2 class="post-title">Save Our Enviroment</h2>
          </header>
          <article class="post-content cause-item">
            <span class="post-meta meta-data">
              <span><i class="fa fa-calendar"></i> 1st Nov, 2022</span>
              <span><i class="fa fa-archive"></i> <a href="#">India</a>, <a href="#">India</a></span>
            </span>
            ...
            <div class="row">
              ...
              <div class="col-md-5">
                <ul class="list-group">
                  ...
                  <li class="list-group-item"> <span class="badge">100000 Rs.</span> Amount Needed </li>
                  <li class="list-group-item"> <span class="badge">1000 Rs.</span> Collected yet </li>
            ...
            <p>there is a demo sentence after some time we fill it with suitable words</p>
          </article>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <p class="small short">If you would prefer to contact in your donation, contact us on our instagrm</p>
                </div>
              </div>
            </div>
          </div>
